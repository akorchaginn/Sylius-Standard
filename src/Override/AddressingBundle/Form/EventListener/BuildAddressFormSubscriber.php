...
namespace Override\AddressingBundle\Form\EventListener;
...
final class BuildAddressFormSubscriber implements EventSubscriberInterface
{
    ...
    public function preSetData(FormEvent $event): void
    {
        ...
        $form->add($this->createFiasCodeForm());
    ...
    private function createFiasCodeForm(?string $fiasCode = null): FormInterface
    {
        return $this->formFactory->createNamed('fiasCode', TestType::class, $fiasCode, []);
    }
